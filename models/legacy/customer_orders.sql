...
-- Now that we've replaced the sources we are actually going to leave this one alone
-- from here, our refactoring strategy is to create a new model in the marts folder
-- and we'll keep on chugging.
-- fully refactored code at /models/marts/fct_customer_orders.sql
